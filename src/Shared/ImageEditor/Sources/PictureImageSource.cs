...
{
    public class PictureImageSource(SKPicture image, IImageEditor editor) : BaseImageSource(editor)
    {
        ...
        public override Rect Bound => new(0, 0, Source.CullRect.Width, Source.CullRect.Height);
